<template>
    <div class="contenedor-login">
      <div class="formulario-login">
        ...
        <p class="greeting-message" v-if="isLoggedIn">Hola, {{ usuario }}! Bienvenido</p>
        ...
        <form @submit.prevent="iniciarSesion">
          ...
          <p class="texto-registro"><span @click="irARegistrar" class="enlace-registro">Regístrate</span></p>
  ...
  const reiniciarTemporizador = () => {
    ...
    tiempoInactividad = setTimeout(cerrarSesion, 10000); // Inicia un nuevo temporizador de 5 segundos
  };
