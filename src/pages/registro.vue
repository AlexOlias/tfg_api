<template>
    ...
    <div class="register-container">
      <div class="register-box">
        ...
        <div class="input-group">
          ...
          <input v-model="password" type="password" placeholder="Contraseña (5 caracteres)" />
        ...
        <p class="login-link"><a href="#" @click="goToLogin">Inicia sesión</a></p>
      </div>
    </div>
  </template>
  ...
  @use "/src/assets/registro.scss" as *;
  </style>
